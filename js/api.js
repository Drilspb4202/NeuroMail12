...
class MailSlurpApi {
    constructor() {
        ...
        // Дополнительно вызываем принудительную инициализацию
        this.keyPool.forceInitialState();
        
        // Защищенный публичный API ключ - берется из пула
        this.publicApiKey = this.keyPool.getNextAvailableKey() || '69c1983367897df2e0f28e68eeab1567312e7b8cb63b32924b13f09b4e5ef959';
        ...
        // Время жизни почтового ящика при использовании публичного API (10 минут в миллисекундах)
        this.publicApiInboxLifetime = 10 * 60 * 1000;
    ...
    checkForApiKeyIssues() {
        ...
        const oldKeys = [
            ...
            'a01b73151f5388b5ca3354b1895fb302c9c172c0e7e5eaf75b1923557fc4cb8b',
