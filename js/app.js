...
Пароль: ${this.generatorData.password}`;
    ...
    checkInboxDeleteTimer() {
        ...
        const inboxDeleteTimer = parseInt(localStorage.getItem('mailslurp_inbox_delete_timer') || '10');
    ...
    initDeleteTimerSettings() {
        ...
        const savedTimer = parseInt(localStorage.getItem('mailslurp_inbox_delete_timer') || '10');
